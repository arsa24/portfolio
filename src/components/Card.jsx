const Card = ({ img, title, date }) => {
  return (
    <div className="rounded-lg border border-[#dddddd] hover:shadow-lg transition-shadow">
      <img src={img} alt="" className="object-cover rounded-t-md h-48 w-full" />
      <div className="flex flex-col gap-4 pt-4 px-4 pb-6">
        <div>
          <h2>{title}</h2>
          <h3>
            Tanggal: <span>{date}</span>
          </h3>
        </div>
